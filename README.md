...
* Reason why AdGuard raw entries generate more DNR rules is that they are finer grained (ANR rules re hanlded by the browser and are processed very efficiently).
