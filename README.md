...
Because I added AdGuard skills (and uBO-lite is more programmed towards efficiency and performance than AdGuard Mv3) I wanted to regain the efficieny by using old and forgotten structured programming principles to streamline and optimize the code for performance, security and maintainability.  
